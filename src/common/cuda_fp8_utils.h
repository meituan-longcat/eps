...
fp8x4_e4m3_to_bfloat2(__nv_bfloat162* out1, __nv_bfloat162* out2, const __nv_fp8x4_e4m3* in) {
  ...
  *out1 = __nv_bfloat162(
      (float)reinterpret_cast<const __nv_fp8_e4m3*>(&tmp_val.x)[0],
      (float)reinterpret_cast<const __nv_fp8_e4m3*>(&tmp_val.y)[0]);
  *out2 = __nv_bfloat162(
      (float)reinterpret_cast<const __nv_fp8_e4m3*>(&tmp_val.z)[0],
...
__inline__ __device__ __nv_bfloat162 fp8x2_e4m3_to_bfloat2(const __nv_fp8x2_e4m3* in) {
  ...
  __nv_bfloat162 out = __nv_bfloat162(
      (float)reinterpret_cast<const __nv_fp8_e4m3*>(&tmp_val.x)[0],
      (float)reinterpret_cast<const __nv_fp8_e4m3*>(&tmp_val.y)[0]);
  return out;
}
...
// e4m3 --> half
__inline__ __device__ half fp8_e4m3_to_half(const __nv_fp8_e4m3& in) {
  return __nv_cvt_fp8_to_halfraw((__nv_fp8_storage_t&)in, __nv_fp8_interpretation_t::__NV_E4M3);
}

// float --> e4m3
__inline__ __device__ __nv_fp8_e4m3 float_to_fp8_e4m3(const float& in) {
  __nv_fp8_e4m3 res;
  (__nv_fp8_storage_t&)res =
      __nv_cvt_float_to_fp8(in, __nv_saturation_t::__NV_SATFINITE, __nv_fp8_interpretation_t::__NV_E4M3);
  return res;
}

// half --> e4m3
__inline__ __device__ __nv_fp8_e4m3 half_to_fp8_e4m3(const half& in) {
  __nv_fp8_e4m3 res;
  (__nv_fp8_storage_t&)res =
      __nv_cvt_halfraw_to_fp8((__half_raw&)in, __nv_saturation_t::__NV_SATFINITE, __nv_fp8_interpretation_t::__NV_E4M3);
  return res;
}

// bf16 --> e4m3
__inline__ __device__ __nv_fp8_e4m3 bfloat16_to_fp8_e4m3(const __nv_bfloat16& in) {
  __nv_fp8_e4m3 res;
  (__nv_fp8_storage_t&)res = __nv_cvt_bfloat16raw_to_fp8(
      (__nv_bfloat16_raw&)in, __nv_saturation_t::__NV_SATFINITE, __nv_fp8_interpretation_t::__NV_E4M3);
  return res;
}

// e4m3x2 --> half2
__inline__ __device__ half2 fp8x2_e4m3_to_half2(const __nv_fp8x2_e4m3& in) {
  return __nv_cvt_fp8x2_to_halfraw2((__nv_fp8x2_storage_t&)in, __nv_fp8_interpretation_t::__NV_E4M3);
}

// float2 --> e4m3x2
__inline__ __device__ __nv_fp8x2_e4m3 float2_to_fp8x2_e4m3(const float2& in) {
  __nv_fp8x2_e4m3 res;
  (__nv_fp8x2_storage_t&)res =
      __nv_cvt_float2_to_fp8x2(in, __nv_saturation_t::__NV_SATFINITE, __nv_fp8_interpretation_t::__NV_E4M3);
  return res;
}

// half2 --> e4m3x2
__inline__ __device__ __nv_fp8x2_e4m3 half2_to_fp8x2_e4m3(const half2& in) {
  __nv_fp8x2_e4m3 res;
  (__nv_fp8x2_storage_t&)res = __nv_cvt_halfraw2_to_fp8x2(
      (__half2_raw&)in, __nv_saturation_t::__NV_SATFINITE, __nv_fp8_interpretation_t::__NV_E4M3);
  return res;
}

// bf16x2 --> e4m3x2
__inline__ __device__ __nv_fp8x2_e4m3 bfloat162_to_fp8x2_e4m3(const __nv_bfloat162& in) {
  __nv_fp8x2_e4m3 res;
  (__nv_fp8x2_storage_t&)res = __nv_cvt_bfloat16raw2_to_fp8x2(
      (__nv_bfloat162_raw&)in, __nv_saturation_t::__NV_SATFINITE, __nv_fp8_interpretation_t::__NV_E4M3);
  return res;
}
